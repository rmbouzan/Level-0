...
public class MadlibsOfTheAmazon {
	public static void main(String[] args) {
		...
		// If you find yourself having to cross a paranoia-infested river, here's how to do it...
...
String place = JOptionPane.showInputDialog("Give me a location!");
...
JOptionPane.showMessageDialog(null, "HAR HAR");		
